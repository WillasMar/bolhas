...
CREATE DATABASE IF NOT EXISTS `bolhas` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `bolhas`;
...
INSERT INTO `usuarios` (`id`, `usuario`, `senha`, `nome`, `img`) VALUES
	(1, 'willasmar', '202cb962ac59075b964b07152d234b70', 'Willas Mar', NULL);
